...
public class Modelcustom_model<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("sbv", "modelcustom_model"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition legleft = partdefinition.addOrReplaceChild("legleft", CubeListBuilder.create(), PartPose.offset(3.0F, 24.0F, -1.0F));
		PartDefinition cube_r1 = legleft.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(34, 60).addBox(-8.0F, -15.1F, -1.0F, 2.0F, 15.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r2 = legleft.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(50, 61).addBox(-8.0F, -22.8F, 5.6F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 0.0F, -5.0F, -2.6616F, 0.6545F, 3.1416F));
		PartDefinition legright = partdefinition.addOrReplaceChild("legright", CubeListBuilder.create(), PartPose.offset(-12.0F, 24.0F, 15.0F));
		PartDefinition cube_r3 = legright.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(26, 60).addBox(-8.0F, -15.0F, -1.0F, 2.0F, 15.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = legright.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(42, 61).addBox(-8.0F, -22.8F, 5.6F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r5 = Body.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -45.5F, -13.8F, 16.0F, 23.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, -9.0F, -3.1416F, 0.0F, 3.1416F));
		PartDefinition armleft = partdefinition.addOrReplaceChild("armleft", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 11.0F));
		PartDefinition cube_r6 = armleft.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(0, 0).addBox(-10.0F, -44.0F, -12.0F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = armleft.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(33, 30).addBox(-15.1F, -42.4F, 1.2F, 2.0F, 2.0F, 19.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r8 = armleft.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(34, 45).addBox(-13.0F, -43.0F, -6.0F, 15.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r9 = armright.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(0, 0).addBox(-10.4164F, -47.2814F, 2.6308F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r10 = armright.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(33, 30).addBox(-6.847F, -42.1047F, 13.722F, 2.0F, 2.0F, 19.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r11 = armright.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(34, 45).addBox(-10.8272F, -42.6096F, 8.8367F, 15.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-8.0F, 0.0F, 0.0F, -3.0416F, 0.0172F, 2.8018F));
		PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 6.0F));
		PartDefinition cube_r12 = Head.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(122, 125).addBox(2.0F, -61.0F, -8.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(122, 125)
		...
		PartDefinition cube_r13 = Head.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(50, 30).addBox(-5.0F, 55.0F, 1.0F, 3.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(24, 49)
						...
						.addBox(-4.0F, 53.0F, 6.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 3).addBox(-4.0F, 53.0F, 3.0F, 1.0F, 2.0F,
