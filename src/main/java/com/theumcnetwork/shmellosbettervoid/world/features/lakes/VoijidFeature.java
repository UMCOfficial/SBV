...
package com.theumcnetwork.shmellosbettervoid.world.features.lakes;
...
public class VoijidFeature extends LakeFeature {
	public static VoijidFeature FEATURE = null;
	public static Holder<ConfiguredFeature<LakeFeature.Configuration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new VoijidFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("sbv:voijid", FEATURE,
				new LakeFeature.Configuration(BlockStateProvider.simple(SbvModBlocks.VOIJID.get()), BlockStateProvider.simple(Blocks.AIR)));
		PLACED_FEATURE = PlacementUtils.register("sbv:voijid", CONFIGURED_FEATURE,
