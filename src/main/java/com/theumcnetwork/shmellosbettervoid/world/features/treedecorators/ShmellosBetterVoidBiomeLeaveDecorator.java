...
public class ShmellosBetterVoidBiomeLeaveDecorator extends LeaveVineDecorator {
	public static final ShmellosBetterVoidBiomeLeaveDecorator INSTANCE = new ShmellosBetterVoidBiomeLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("shmellos_better_void_biome_tree_leave_decorator");
