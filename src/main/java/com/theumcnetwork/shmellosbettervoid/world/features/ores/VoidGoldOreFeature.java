...
public class VoidGoldOreFeature extends OreFeature {
	public static VoidGoldOreFeature FEATURE = null;
	public static Holder<ConfiguredFeature<OreConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new VoidGoldOreFeature();
	...
	private static class VoidGoldOreFeatureRuleTest extends RuleTest {
		static final VoidGoldOreFeatureRuleTest INSTANCE = new VoidGoldOreFeatureRuleTest();
		private static final com.mojang.serialization.Codec<VoidGoldOreFeatureRuleTest> CODEC = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		private static final RuleTestType<VoidGoldOreFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;

		@SubscribeEvent
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("sbv:void_gold_ore_match"), CUSTOM_MATCH);
		}
