...
import com.theumcnetwork.shmellosbettervoid.item.VoidStoneItem;
...
public class SbvModItems {
	...
	public static final RegistryObject<Item> VOID_IRON_ORE = block(SbvModBlocks.VOID_IRON_ORE, SbvModTabs.TAB_SHMELLOS_BETTER_VOID);
	public static final RegistryObject<Item> VOID_IRON_BLOCK = block(SbvModBlocks.VOID_IRON_BLOCK, SbvModTabs.TAB_SHMELLOS_BETTER_VOID);
	...
	public static final RegistryObject<Item> VOID_DIAMOND_ORE = block(SbvModBlocks.VOID_DIAMOND_ORE, SbvModTabs.TAB_SHMELLOS_BETTER_VOID);
	public static final RegistryObject<Item> VOID_DIAMOND_BLOCK = block(SbvModBlocks.VOID_DIAMOND_BLOCK, SbvModTabs.TAB_SHMELLOS_BETTER_VOID);
	...
	public static final RegistryObject<Item> VOID_GOLD_ORE = block(SbvModBlocks.VOID_GOLD_ORE, SbvModTabs.TAB_SHMELLOS_BETTER_VOID);
	public static final RegistryObject<Item> VOID_GOLD_BLOCK = block(SbvModBlocks.VOID_GOLD_BLOCK, SbvModTabs.TAB_SHMELLOS_BETTER_VOID);
	...
	public static final RegistryObject<Item> VOID_STONE_ORE = block(SbvModBlocks.VOID_STONE_ORE, SbvModTabs.TAB_SHMELLOS_BETTER_VOID);
	public static final RegistryObject<Item> VOID_STONE_BLOCK = block(SbvModBlocks.VOID_STONE_BLOCK, SbvModTabs.TAB_SHMELLOS_BETTER_VOID);
	public static final RegistryObject<Item> VOIDITE_DUST = REGISTRY.register("voidite_dust", () -> new VoiditeDustItem());
	public static final RegistryObject<Item> VOIDITE_ORE = block(SbvModBlocks.VOIDITE_ORE, SbvModTabs.TAB_SHMELLOS_BETTER_VOID);
	public static final RegistryObject<Item> VOIDITE_BLOCK = block(SbvModBlocks.VOIDITE_BLOCK, SbvModTabs.TAB_SHMELLOS_BETTER_VOID);
