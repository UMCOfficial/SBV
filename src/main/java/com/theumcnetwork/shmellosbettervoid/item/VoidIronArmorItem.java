...
public abstract class VoidIronArmorItem extends ArmorItem {
	public VoidIronArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends VoidIronArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "sbv:textures/models/armor/voidiron_layer_1.png";
		}
	}
	...
	public static class Leggings extends VoidIronArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "sbv:textures/models/armor/voidiron_layer_2.png";
		}
	}
